...
![Map of 5 Bodies — Possibility Management map](../Maps/M06.png)

**What it is.** You did not arrive as a brain with plumbing but as a **five-body organism** in which the brain was the loudest body; the map recovers the other four. The five: **intellectual** (thoughts, words, plans), **emotional** (the four feelings as sensations in chest, belly, throat), **physical** (bones, muscles, breath, gut, skin), **energetic** (the subtle field around and through you, your "feel" in a room), **archetypal** (larger-than-personal patterns moving through you). Each has its own intelligence, language, and food. The map is the instrument panel for noticing which bodies are online and which have run on emergency power since you were nine. A distinction installs in all five or it is one-fifth done.
