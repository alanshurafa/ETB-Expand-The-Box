...
**At a glance.** Old map vs new map → sorting (good/bad) vs archetypal energies with purpose; the sort is the central error · Good/bad framing is the error, not the contents · Gendered distortions → anger suppressed in women and "nice" people, sadness and fear suppressed in men · Functional in patriarchy, dysfunctional in archiarchy → not a moral verdict · Numbness is the load-bearing mechanism (Map 9) · Naming the specific rule is most of the work.

## How to explain it verbally

The Old Map of Feelings is the one you were issued as a kid by family, school, religion, gender training. It sorts the four feelings into good and bad, forbids three outright, waters down the fourth, and runs on numbness to keep it smooth. It was functional: it kept you controllable, predictable, and quiet about what you actually felt, which is what patriarchal culture needed. The cost was stored emotion, mixed-emotion soup, and recurring drama. The good-versus-bad sorting is the error, not which feeling landed in which column. You are not here to fight this map. You are here to see it precisely enough that it stops running you.

**If you only remember one thing:** the sorting into good and bad is the bug; naming your specific rule is most of the cure.
...
> - **Interactive tool →** [Map Atlas · Map 8 Old Map of Feelings](../Map%20Atlas/M08%20-%20Old%20Map%20of%20Feelings.html)
