...
![Map of 3 Games — Possibility Management map](../Maps/M47.png)
...
There are three ways a game between people can be set up. Game 1 is I win, you lose: hierarchy, competition, and the map writes the word gremlin right into this line, because the drama triangle lives here. Somebody has to lose for the food to get produced. Game 2 is win-win, plus its shadow, lose-lose, and the map is honest about the underside: secret competition and compromise, a lot of "win-win" that is really game 1 with both players quietly keeping score. Game 3 is winning happening, a game built so there is no option to lose: always learning, generosity, sharing research, where a Beep! is design data, not defeat. The Responsible Game at the kitchen table and high drama at the scale of a whole field are both game 3. Nobody has to lose, because what is being produced is learning and creation, not gremlin food.

**If you only remember one thing:** game 3 is built so nobody has to lose; the Responsible Game and high drama both live there, producing learning instead of gremlin food.
